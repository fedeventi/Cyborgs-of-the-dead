...
Shader "Guide"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 uv_TexCoord4 = i.uv_texcoord * appendResult26.xy + _Vector2;
			...
			float lerpResult23 = lerp( 0.0 , lerpResult11 , saturate( ( 1.0 - ( uv_TexCoord4.x + (2.0 + (_Mask - 0.0) * (-1.0 - 2.0) / (1.0 - 0.0)) ) ) ));
...
/*ASEBEGIN
Version=17800
408;277;1109;409;2004.31;-297.2828;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;24;-1867.976,-315.4818;Inherit;False;Property;_Float2;Float 2;3;0;Create;True;0;0;False;0;0;0.009003924;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-1537.373,426.6099;Inherit;False;Property;_Mask;Mask;2;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;14;-1662.589,-117.7957;Inherit;False;Property;_Vector2;Vector 2;1;0;Create;True;0;0;False;0;0,0;-0.76,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SaturateNode;21;-171.2154,343.8372;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=D8DDA5728BFFA982A82F3B080DC0ACBCD1744EB7