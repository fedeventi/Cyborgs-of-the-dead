...
Shader "Shield little"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float fresnelNode215 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV215, 0.34 ) );
			float4 color213 = IsGammaSpace() ? float4(0,0.1058824,0.7490196,1) : float4(0,0.0109601,0.5209957,1);
			float4 temp_output_218_0 = ( ( ( color183 + float4( 0,0,0,0 ) ) + fresnelNode215 ) + ( color213 + float4( 0,0,0,0 ) ) );
			o.Albedo = temp_output_218_0.rgb;
...
/*ASEBEGIN
Version=17800
0;729;864;270;1582.66;873.3156;3.094385;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;216;-657.1512,-87.69182;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;False;0;0.34;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FresnelNode;215;-334.0765,-177.9577;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;213;-245.6378,-663.4993;Inherit;False;Constant;_Color3;Color 2;2;1;[HDR];Create;True;0;0;False;0;0,0.1058824,0.7490196,1;0.5518868,0.7574644,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;214;4.966391,-510.0974;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;220;296.1565,-185.051;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;210;-417.4092,161.6629;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;177;276.8048,399.5537;Inherit;False;Constant;_Float5;Float 5;2;0;Create;True;0;0;False;0;0.2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;219;654.524,-10.95813;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=325918F20A3D6B0C2EBDCB2E54D1D03EB79FE6E8